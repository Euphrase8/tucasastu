    ...
    <>
      ...
      <div className="min-h-screen bg-divine-light py-20">
        <div className="container">
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {media.map((item) => {
                ...
                return (
                  <Card key={item.ID} className="group overflow-hidden border-0 shadow-card hover:shadow-divine transition-all duration-300">
                    <div className="relative aspect-[4/3] overflow-hidden">
                      ...
                      {isCollection && (
                        <Button
                          ...
                          onClick={() => handleViewCollection(files.map(f => `https://api.tucasastu.com/${f}`))}
                        >
          ...
          {/* Collection Modal */}
          <Dialog open={openCollection} onClose={() => setOpenCollection(false)} className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
